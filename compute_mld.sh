...
## Each simulation takes around 20 seconds, so 1000 runs should take around around 6 hours
...
for i in `seq 1 1000`;
do
	./simulate_evolving_seq K=1000 L=1000000 id=0 lambda=0.05 mu=1 t0=1.00000 t1=2.5
